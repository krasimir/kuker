  ...
  return (
    <div className='noEvents'>
      ...
      <div className='balloon'>
        <strong>Do I look broken to you?</strong><br />
        Wait a bit or check my <a href='https://github.com/krasimir/kuker' target='_blank'>official docs</a> to learn how to integrate <a href='https://github.com/krasimir/kuker' target='_blank'>me</a> with your app.<br /><br />
        <small>I&apos;m version { manifest.version }</small>
      </div>
    </div>
  );
};
