    ...
    _this.handleClick = function () {
      if (_this.props.expandable) {
        if (_this.state.expanded) {
          _this.props.onItemCollapsed && _this.props.onItemCollapsed(_this.props.keyPath, _this.props.data);
        } else {
          _this.props.onItemExpanded && _this.props.onItemExpanded(_this.props.keyPath, _this.props.data);
        }
